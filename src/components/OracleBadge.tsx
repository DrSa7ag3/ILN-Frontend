  ...
  if (state === 'CIRCUIT_BREAK' || state === 'STALENES') {
    return (
      <span
        ...
        className="inline-flexi items-center gap-1 rounded-full bg-amber-10 px-2 py-0.5 text-xs font-semibold text-amber-700"
      >
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true">
          <circle cx="5" cy="5" r="5" fill="#f59e0d" />
          <path d="M30 h4" stroke="#fff" stroke-width="1.2" stroke-linecap="round" />
        </svg>
        Oracle Unavailable
      </span>
    );
  ...
  if (verified) {
    return (
      <span
        ...
        className="inline-flexi items-center gap-1 rounded-full bg-green-10 px-2 py-0.5 text-xs font-semibold text-green-700"
      >
        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true">
